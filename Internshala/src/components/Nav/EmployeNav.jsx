...
import { asyncemployesignout } from '../../store/userAction'
Link
      ...
      <div className='navbar h-[13.5vh] w-full bg-gray-100  flex justify-between items-center px-3 lg:px-10'>
       ...
       <div className='flex gap-8 items-center relative'>
        ...
        <>
          ...
          {user.user && (
            <>
            <div className='h-11 w-11 bg-red-200 rounded-full overflow-hidden'
             onMouseEnter={handleMouseEnter}
             onMouseLeave={handleMouseLeave}>
             <img src= {`${user.user.organizationlogo.url}`} alt="" />
            </div>
            {isMouseOpen && (
              ...
              onMouseLeave={handleMouseLeave}>
                ...
                <Link to="/resume" className='text-md flex mt-5 font-semibold text-blue-500  '>Edit Profile </Link>
