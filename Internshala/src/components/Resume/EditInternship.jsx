...
import { addJob, asynloaduser, updateInternship, updateJob } from '../../store/userAction'
...
const EditInternship = ({internshipData, onClose}) => {
  ...
  const [formData, setformData] = useState({
    ...
    remoteOrOffice:internshipData.remoteOrOffice||"",
  ...
  const submitHandler = async (e)=>{
     e.preventDefault()
      // Handle form submission, e.g., dispatching an action to update job
     try{
        await dispatch(updateInternship(formData, internshipData.id))
        onClose();
  ...
  return (
    ...
    <div className='px-3 py-5 lg:px-8 lg:bg-gray-100 lg:mr-40'>
        <h1 className='text-xl font-semibold text-center'>Edit Job</h1>
        <form action="">
            
            <div className='flex gap-4 lg:gap-20 mt-8 lg:mt-8'>
                <div>
