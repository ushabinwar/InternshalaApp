...
import {  addTraining, asynloaduser } from '../../store/userAction'
...
const AddTraining = ({onClose}) => {
  ...
  const submitHandler = async(e)=>{
     e.preventDefault()
      // Handle form submission, e.g., dispatching an action to add the training
        await dispatch(addTraining(formData));
        onClose();
  ...
  return (
    ...
    <div className='px-3 py-5 lg:px-8 bg-gray-100 border shadow'>
        <h1 className='text-xl font-semibold text-center'>Add Training/Course</h1>
        <form action="">
