...
const AddDiplomaForm = ({onClose, type}) => {
  ...
  const [educationData, seteducationData] = useState({
    ...
    startYear : '',
    endYear : '',
    stream : '', // Adjusted for diploma, removing degree and percentage fields
    percentage : '',
    type : type === "Graduation" ? "Graduation" : "Diploma" // Automatically set the type
