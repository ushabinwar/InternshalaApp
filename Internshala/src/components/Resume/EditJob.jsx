...
import { addJob, asynloaduser, updateJob } from '../../store/userAction'
...
const EditJob = ({jobData, onClose}) => {
  ...
  const submitHandler = async (e)=>{
     ...
     try{
        await dispatch(updateJob(formData, jobData.id))
        onClose();
  ...
  return (
    ...
    <div className='px-3 py-5 lg:px-7 lg:bg-gray-100 lg:mr-40'>
